(function(){
  ...
  var SEGMENT_GROUPS=[
    ...
    {label:'Vans',items:[{v:'Minivan',eg:'Toyota Sienna, Honda Odyssey, Kia Carnival'}]},
  ...
  FILTERS.push(
    {key:'make',label:'Make',col:2,opts:[{v:'Acura'},{v:'Audi'},{v:'BMW'},{v:'Cadillac'},{v:'Chevrolet'},{v:'Ford'},{v:'GMC'},{v:'Genesis'},{v:'Honda'},{v:'Hyundai'},{v:'Infiniti'},{v:'Jeep'},{v:'Kia'},{v:'Lexus'},{v:'Lincoln'},{v:'Mazda'},{v:'Mercedes-Benz'},{v:'Nissan'},{v:'Porsche'},{v:'Subaru'},{v:'Tesla'},{v:'Toyota'},{v:'Volvo'}]},
    {key:'model',label:'Model',col:2,dynamic:true,opts:[]},
    {key:'body_style',label:'Body Style',col:1,dataKey:'body_type',opts:[{v:'SUV',match:['SUV','Wagon']},{v:'Sedan',match:['Sedan','Hatchback','Coupe','Convertible','Targa']},{v:'Truck',match:['Pickup']},{v:'Minivan',match:['Minivan']}]},
  ...
  var MODELS_BY_MAKE={Acura:['Integra','MDX','RDX','TLX','ZDX'],Audi:['A4','A6','A7','Q3','Q5','Q7','Q8','e-tron GT'],BMW:['2 Series','3 Series','4 Series','5 Series','7 Series','8 Series','X1','X2','X3','X4','X5','X6','X7','iX'],Cadillac:['CT4','CT5','Escalade'],Chevrolet:['Malibu','Silverado 1500','Tahoe'],Chrysler:['Pacifica'],Dodge:['Durango','Hornet'],Ford:['Bronco','Bronco Sport','Expedition','F-150','Maverick','Mustang Mach-E'],GMC:['Sierra 1500','Yukon'],Genesis:['G70','GV70','GV80'],Honda:['Accord','CR-V','Civic','HR-V','Insight','Odyssey','Passport','Pilot','Ridgeline'],Hyundai:['Elantra','Ioniq 5','Ioniq 6','Kona','Palisade','Santa Cruz','Santa Fe','Sonata','Tucson'],Infiniti:['Q50','QX50','QX55','QX60','QX80'],Jeep:['Gladiator','Grand Cherokee','Grand Cherokee L','Grand Wagoneer','Wagoneer'],Kia:['Carnival','EV6','K5','Niro','Seltos','Sorento','Soul','Sportage','Telluride'],Lexus:['ES','GX','IS','LS','LX','NX','RX','RZ','TX','UX'],Lincoln:['Aviator','Corsair','Nautilus','Navigator'],Mazda:['CX-30','CX-5','CX-50','CX-90','Mazda3'],'Mercedes-Benz':['A-Class','CLA','CLE','E-Class','EQB','EQS','GLA','GLB','GLC','GLE','GLS','S-Class'],Mini:['Countryman'],Nissan:['Altima','Ariya','Frontier','Rogue'],Porsche:['Cayenne','Macan','Panamera','Taycan'],Subaru:['Ascent','Crosstrek','Forester','Outback','Solterra'],Tesla:['Model 3','Model S','Model X','Model Y'],Toyota:['4Runner','C-HR','Camry','Corolla','Corolla Cross','Crown','Grand Highlander','Highlander','Prius','RAV4','Sequoia','Sienna','Tacoma','Tundra','Venza','bZ4X'],Volvo:['XC60','XC90']};
